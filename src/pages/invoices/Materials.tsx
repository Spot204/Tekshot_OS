...
function Materials () {
    ...
    const pageData = mockMaterials.slice((page - 1) * pageSize, page * pageSize);
    ...
    return (
        <div className="bg-light mt-5 pt-5">
            <div className="fs-4 fw-bold mb-3">
                <i className="bi bi-box-seam text-warning"/> Vật tư
            </div>
                ...
                <Card className="mb-3">
                    <div className="d-flex flex-wrap align-items-center gap-2">
                        <div className="flex-grow-1" style={{ minWidth: "220px" }}>
                            <Input state="none" leftIcon={<i className="bi bi-search"/>} placeholder="Tìm kiếm vật tư..." value={keyword} onChange={(e) => setKeyword(e.target.value)}></Input>
                        </div>
