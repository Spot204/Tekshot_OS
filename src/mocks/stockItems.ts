...
const build = (kind: StockItemKind, rows: Row[]): StockItem[] =>
  rows.map(
    ([name, unit, stock, minStock, price, supplier, location, day], index) => ({
...
export const materials: StockItem[] = build("material", [
  ...
  [
    ...
    40,
    185_000,
    "Công ty CP Cà phê Buôn Ma Thuột",
    "Kho chính",
    26,
  ],
  [
...
export const tools: StockItem[] = build("tool", [
  [
    "Lò nướng pizza 2 tầng",
    "Cái",
    3,
    2,
    42_000_000,
    "Công ty Thiết bị Bếp Á Âu",
    "Kho chính",
    28,
  ],
  [
