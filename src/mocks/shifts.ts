...
const RAW: Row[] = [
  ...
  ["2026-07-21", 1, "NV0006", 1_500_000, 13_500_000, 5_200_000, 0, -50_000, "Thiếu tiền lẻ"],
  ...
  ["2026-07-23", 1, "NV0018", 1_000_000, 14_900_000, 5_800_000, 300_000, 100_000, "Khách trả dư, chưa trả lại"],
  ["2026-07-24", 0, "NV0001", 2_000_000, 9_200_000, 2_400_000, 0, 0, ""],
  ["2026-07-24", 1, "NV0002", 1_500_000, 13_100_000, 4_900_000, 0, 0, ""],
  ["2026-07-25", 0, "NV0004", 1_500_000, 9_200_000, 3_000_000, 50_000, -50_000, "Chưa rõ nguyên nhân"],
  ...
  ["2026-07-27", 1, "NV0018", 1_000_000, 8_600_000, 4_000_000, 100_000, 100_000, "Thừa quỹ"],
  ["2026-07-28", 0, "NV0001", 2_000_000, 12_500_000, 2_750_000, 0, 0, ""],
  ["2026-07-28", 1, "NV0002", 1_500_000, 13_200_000, 5_700_000, 0, 0, "Chốt ca cuối tháng"],
];
...
export const shiftClosings: ShiftClosing[] = RAW.map(
  (
    [day, slot, employeeId, openingCash, cashSales, transferSales, cashOut, drift, note],
    index,
  ) => ({
