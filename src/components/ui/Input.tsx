...
const Input = forwardRef<HTMLInputElement, InputProps>(({ className = "", size = "md", state = "none", leftIcon, rightIcon, message, style, ...rest}, ref) => {
    const sizeClass 
        ...
        return (
            <div>
                <div style={{ position: "relative" }}>
                    {leftIcon && (
                        <span
                            style={{ position: "absolute", top: "50%", left: "0.75rem", transform: "translateY(-50%)", color: "#6c757d", pointerEvents: "none", display: "inline-flex"}}>
                            {leftIcon}
                        </span>
                    )}
                    ...
                    {rightIcon && (
                        <span
                            style={{ position: "absolute", top: "50%", right: "0.75rem", transform: "translateY(-50%)", color: "#6c757d", pointerEvents: "none", display: "inline-flex"}}>
                            {rightIcon}
                        </span>
                    )}
                </div>
